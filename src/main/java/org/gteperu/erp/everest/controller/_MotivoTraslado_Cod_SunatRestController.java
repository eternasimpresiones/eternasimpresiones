...
@RestController
@RequestMapping(value = "/api/motivo_tras_cod_sunat")
public class _MotivoTraslado_Cod_SunatRestController {
	 @Resource(name = "motivoTraslado_Cod_SunatService")
	 _MotivoTraslado_Cod_SunatService motivoTraslado_Cod_SunatService;
	
	 /*
	  * retorna el codigo sunat del motivo de traslado 
	  */
	 @Transactional(propagation=Propagation.REQUIRED, rollbackFor=Exception.class)
	 @RequestMapping(value = "/retornarMotivoTrasladoCodigoSunat", method = RequestMethod.POST)
	 public ResponseWrapper retornarMotivoTrasladoCodigoSunat(@RequestBody @Validated _MotivoTrasladoCodigoSunat MotivoTrasladoCodigoSunat, HttpServletRequest request) throws Exception {
		 ...
		 HttpSession session = request.getSession();
		    ...
		    try {
		                    ...
		                    objtList = motivoTraslado_Cod_SunatService.retornarMotivoTrasladoCodigoSunat(MotivoTrasladoCodigoSunat);
		    	  ...
		    	  throw new ExceptionResponse(new Date(),	this.getClass().getSimpleName() + "/retornarMotivoTrasladoCodigoSunat",
			 				e.getStackTrace()[0].getFileName() + " => " + e.getStackTrace()[0].getMethodName() + " => " + e.getClass() + " => message: " + 
			 				e.getMessage() + "=> linea nro: " + e.getStackTrace()[0].getLineNumber(),MotivoTrasladoCodigoSunat);
		    } 
		    return obj;

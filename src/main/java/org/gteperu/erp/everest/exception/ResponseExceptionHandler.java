...
@ControllerAdvice // simula Inteceptor , lo convierte en transversal a todas las capas del proyecto
...
public class ResponseExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public final ExceptionResponse 	handleException(ExceptionResponse ex,WebRequest request){
		ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), ex.getMensaje(),ex.getDetalles(), ex.getJsonSender());
		...
		LOG.error(ex.getMensaje() + " -- jsonSender:" + json, new RuntimeException(ex.getDetalles()));
		return exceptionResponse;
